    ...
    public void consultationUpdate() {
        ...
        jButton.addActionListener(e -> {
            ...
            try {
                ...
                String sql = "UPDATE consultationinformation SET day0AM = ?," +
                        " day0PM = ?,day1AM = ?, day1PM = ?,day2AM = ?, day2PM = ?,day3AM = ?, " +
                        "day3PM = ?,day4AM = ?, day4PM = ?,day5AM = ?, day5PM = ?,day6AM = ?, day6PM = ? WHERE name = ?";
                // 设置需要更新的列和对应的值
